  ...
  return (
    <div>
      <div className='ml-auto mr-auto'>
        <div className='fixed text-center text-primary bottom-[60%] md:bottom-[65%] lg:bottom-[20%] left-0 right-0 -z-20 text-[20vw] md:text-[15vw] leading-none font-anton_display font-extrabold'>
      ...
      <div className='fixed bg-accent w-5/6 left-[10%] bottom-[15vh] md:bottom-[10vh] lg:bottom-[12vh] -z-10 h-1'></div>
    </div>
  );
}
