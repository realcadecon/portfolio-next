...
export const ProjectDisplay: React.FC<{ project: ProjectModel }> = (props) => {
    ...
    return (
        <div ref={container}>
            <a className="relative container" href="/" onMouseEnter={() => {if(timeline) timeline.play()}} onMouseLeave={() => {if(timeline) timeline.reverse()}} onClick={() => gsap.to(".container", { display: "hidden" })}>
