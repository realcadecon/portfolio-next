...
export const Navbar = () => {
    ...
    return (
        <div className="absolute right-[5%] top-[5%] z-[9999]">
            <div className=" bg-neutral-50 p-4 rounded-full shadow-lg drop-shadow-xl flex flex-col justify-center text-center transition ease-in-out hover:cursor-pointer" onClick={() => setNavActive(!navActive)}>
                {!navActive &&
                ...
                {navActive &&
                    <ul className="flex flex-col items-center gap-2 text-center text-primary">
                        ...
                        <a className="" href="/work" title="Projects">
                            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a className="" href="/work" title="Games">
                        ...
                        <a href="/Cade_Conner_Resume.pdf" className="inline" title="Resume">
                            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
